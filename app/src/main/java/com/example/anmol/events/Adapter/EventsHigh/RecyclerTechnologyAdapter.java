...
public class RecyclerTechnologyAdapter extends RecyclerView.Adapter<RecyclerTechnologyAdapter.ViewHolder> {
    ...
    public RecyclerTechnologyAdapter(Context ctx, List<String> image, List<String> href, List<String> title, List<String> dateTime, List<String> evenue, List<String> genre) {
    ...
    @Override
    public RecyclerTechnologyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        return new RecyclerTechnologyAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.card_events_high_today,parent,false));

    }

    @Override
    public void onBindViewHolder(final RecyclerTechnologyAdapter.ViewHolder holder, int position) {
